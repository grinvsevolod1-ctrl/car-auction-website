    ...
    <section className="px-4 py-16 sm:py-24">
      <div className="relative mx-auto max-w-6xl overflow-hidden rounded-3xl border border-primary/25 bg-card px-6 py-14 text-center sm:px-12 sm:py-20">
        ...
        <p className="mx-auto mt-4 max-w-xl text-pretty text-muted-foreground">
          Зарегистрируйтесь бесплатно, получите доступ к лотам и сделайте первую
          ставку уже сегодня.
        </p>
        <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
          ...
          <Link
            href="/auctions"
            className="inline-flex items-center gap-2 rounded-xl border border-border px-7 py-3.5 font-semibold text-foreground transition-colors hover:bg-muted"
          >
            Смотреть аукционы
          </Link>
        </div>
